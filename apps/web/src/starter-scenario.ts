  ...
  return {
    portfolio: {
      ...
      funds: [
        ...
        { id: "fskax", ticker: "FSKAX", name: "Fidelity Total Market Index Fund", assetClasses: { us_stocks: 10000 } },
        {
          id: "fzilx",
          ticker: "FZILX",
        ...
        { id: "fxnax", ticker: "FXNAX", name: "Fidelity U.S. Bond Index", assetClasses: { us_bonds: 10000 } },
        { id: "fbiix", ticker: "FBIIX", name: "Fidelity International Bond Index", assetClasses: { intl_bonds: 10000 } },
      ],
      accounts: [],
      holdings: [],
    },
